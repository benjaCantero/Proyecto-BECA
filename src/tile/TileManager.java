...
public class TileManager {
	...
	//carga el mapa siguiendo los nunmeros del archivo mapa.0.1.txt
		...
		try {
			...
			while (col < gp.maxWorldCol && row < gp.maxWorldRow) {
				...
				while (col < gp.maxWorldCol) {
					...
					String numbers[] = line.split(" "); // importante siempre dejar un espacio entre las comillas de line.split sino no carga el mapa 
